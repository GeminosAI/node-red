...
parsedArgs = { ...parsedArgs, "settings": "./settings.js" }
...
httpsPromise.then(function (startupHttps) {
    ...
    try {
        //geminos 
        console.log(`Process has environment variable CWY`, process.env.hasOwnProperty("CWY"))
        if(process.env.hasOwnProperty("CWY")){
            console.log("Setting causeway-uri to: ", process.env.CWY)
            settings["causeway-uri"] = process.env.CWY
        }else{
            settings["causeway-uri"] = "docker"
        }
