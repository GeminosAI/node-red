...
if (parsedArgs.settings) {
    ...
    if (fs.existsSync(path.join(process.env.NODE_RED_HOME,".config.json"))) {
        ...
        console.log("Loading settings file from ", process.env.NODE_RED_HOME)
        ...
        if (fs.existsSync(userSettingsFile)) {
            ...
            console.log("user directory provided exists, loading from : ", settingsFile)
        } else {
            ...
            if (settingsStat.mtime.getTime() <= settingsStat.ctime.getTime()) {
                ...
                settingsFile = userSettingsFile;
                console.log("Default settings has not been modified: ", settingsFile)

            } else {
                // Use default settings.js as it has been modified
                settingsFile = defaultSettings;
                console.log("Default settings hasbeen modified: ", settingsFile)
