    ...
    function showWorkspaceToolbar(activeSubflow) {
      ...
      $("#red-ui-subflow-input-remove").on("click", function (event) {
        ...
        if(RED.nodes.subflow(RED.workspaces.active())){
          ...
          var wasChanged = RED.submodel.activeSubmodel.changed;
          RED.submodel.activeSubmodel.changed = true;
          var result = RED.submodel.removeSubmodelInput();
          if (result) {
            var inst = refresh(true);
            RED.history.push({
              t: "delete",
