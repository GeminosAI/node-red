...
RED.workspaces = (function() {
    ...
    function showEditWorkspaceDialog(id) {
        // gem
        console.log("In showEditWorkspaceDialog ", id)
        ...
        if (!workspace) {
            ...
            if (submodel) {
                RED.editor.editSubmodel(submodel);
            }
            return;
        }
    ...
    function createWorkspaceTabs() {
        workspace_tabs = RED.tabs.create({
            ...
            onchange: function(tab) {
                ...
                // RED.events.emit("workspace:submodel-change",event);
            ...
            ondblclick: function(tab) {
                if (tab.type != "subflow" && tab.type!="submodel") {
                    showEditWorkspaceDialog(tab.id);
                } else {
                    if(tab.type == "subflow"){
                        RED.editor.editSubflow(RED.nodes.subflow(tab.id));
                    }
                    if(tab.type == "submodel"){
                        RED.editor.editSubmodel(RED.nodes.submodel(tab.id))
                    }
                }
            },
            onadd: function(tab) {
    ...
    return {
        ...
        show: function(id,skipStack) {
            if (!workspace_tabs.contains(id)) {
                var sf = RED.nodes.subflow(id) ? RED.nodes.subflow(id) : RED.nodes.submodel(id)
                if (sf) {
                    if(sf.type ==="subflow"){
                        addWorkspace(
                    ...
                    }else if(sf.type ==="submodel"){
                        addWorkspace({
                            type:"submodel", id: id, icon:"font-awesome/fa-bolt", label: sf.name, closeable:true},
                            null,
                            workspace_tabs.activeIndex() +1
                        );
                    }
