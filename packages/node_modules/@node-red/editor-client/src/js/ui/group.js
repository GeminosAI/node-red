...
RED.group = (function() {
    ...
    var groupDef = {
        ...
        oneditprepare: function() {
            ...
            $("#node-input-property-container-owns").css("min-height", "500px").css("max-height", "750px").css("min-width","450px").editableList({
            ...
            $("#node-input-property-container-plays").css("min-height", "500px").css("max-height", "750px").css("min-width","450px").editableList({
                addItem:function(container, i , opt){
                    var prop = opt;
                    if (!prop.hasOwnProperty("p")) {
