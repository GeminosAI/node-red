...
RED.group = (function() {
    ...
    var _groupEditTemplate = '<script type="text/x-red" data-template-name="group">'+
        ...
        '<div class= "form-row>'+
            '<div class="form-row node-input-property-container-row">'+
                '<div class="form-row">Owns</div>'+
                '<ol id="node-input-property-container-owns"></ol>'+
            '</div>'+
        '</div>'+
        '<div class="form-row">'+
            '<div class="form-row node-input-property-container-row">'+
                '<div class="form-row">Plays</div>'+
    ...
    var groupDef = {
        ...
        oneditprepare: function() {
            ...
            $("#node-input-property-container-owns").css("min-height", "200px").css("max-height","250px").css("min-width","450px").editableList({
            ...
            $("#node-input-property-container-plays").css("min-height", "125px").css("max-height","125px").css("min-width","450px").editableList({
                addItem:function(container, i , opt){
                    var prop = opt;
                    if (!prop.hasOwnProperty("p")) {
            ...
            for (var i = 0; i < this.props.length; i++) {
                ...
                if (newProp.p === "plays") {
                  console.log("PROPERTY IS OF TYPE PLAYS");
