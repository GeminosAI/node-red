...
RED.group = (function() {
    ...
    var _groupEditTemplate = '<script type="text/x-red" data-template-name="group">'+
        ...
        '<div class="form-row">'+
            ...
            '</div>'+
        '</div>'+
        '<div id="node-input-property-tabs-content">'+
    ...
    var groupDef = {
        ...
        oneditprepare: function() {
            ...
            $("#node-input-property-container-owns").css("min-height", "450px").css("max-height", "750px").css("min-width","450px").editableList({
                addItem:function(container, i , opt){
                    var prop = opt;
                    if (!prop.hasOwnProperty("p")) {
                      prop = { p: "owns", v: "", vt: "string", vtindex: 0 };
                    }
            ...
            $("#node-input-property-container-plays").css("min-height", "450px").css("max-height", "750px").css("min-width","450px").editableList({
                addItem:function(container, i , opt){
                    var prop = opt;
                    if (!prop.hasOwnProperty("p")) {
