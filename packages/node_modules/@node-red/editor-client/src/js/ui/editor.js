...
RED.editor = (function () {
    ...
    function prepareEditDialog(trayBody, nodeEditPanes, node, definition, prefix, defaultTab, done) {
        ...
        if (definition.credentials || /^subflow:/.test(definition.type) || /^submodel:/.test(definition.type) || node.type === "group" || node.type === "tab") {
            if (node.credentials) {
                populateCredentialsInputs(node, definition.credentials, node.credentials, prefix);
                completePrepare();
            } else {
    ...
    function showEditSubmodelDialog(submodel, defaultTab) {
        if (buildingEditDialog) { return }
        buildingEditDialog = true;
        var editing_node = subflow;
        var activeEditPanes = [];
        ...
        var trayOptions = {
            ...
            open: function (tray, done) {
                ...
                $('<span style="margin-left: 10px"><i class="fa fa-info-circle"></i> <i id="red-ui-editor-submodel-user-count"></i></span>').appendTo(trayFooterLeft);
                ...
                var nodeEditPanes = [
                    'editor-tab-properties',
                    'editor-tab-submodel-module',
                    'editor-tab-description',
                    'editor-tab-appearance'
                ];

                prepareEditDialog(trayBody, nodeEditPanes, submodel, submodel._def, "node-input", defaultTab, function (_activeEditPanes) {
                    activeEditPanes = _activeEditPanes;
    ...
    return {
        ...
        createEditor: function (options) {
            console.log("AT CREATE EDITORE ", options)
