...
RED.sidebar = (function() {
    ...
    function showSidebar(id, skipShowSidebar) {
        if (id === ":first") {
            id = lastSessionSelectedTab || RED.settings.get("editor.sidebar.order",["cm","info", "help", "version-control", "debug"])[0]
        }
        if (id) {
    ...
    function init () {
        ...
        sidebar_tabs = RED.tabs.create({
            ...
            order: RED.settings.get("editor.sidebar.order",["cm","info", "help", "version-control", "debug"])
            // scrollable: true
        });
