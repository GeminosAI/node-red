 ...
 **/
 ...
 RED.submodel = (function () {
    ...
    function addSubmodelOutput(id) {
      ...
      RED.nodes.dirty(true);
      RED.view.redraw();
      $("#red-ui-submodel-output .spinner-value").text(submodel.out.length);
      RED.events.emit("submodels:change", submodel);
    }
