...
RED.view = (function() {
    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            linkEnter.each(function(d,i) {
                ...
                // geminos
                if(d.source.type === "entity" || d.source.type === "relation"){
    ...
    function importNodes(newNodesObj,options) {
        console.log( "Importing nodes in view.js : " , newNodesObj, options)
        options = options || {
            addFlow: false,
            touchImport: false,
            generateIds: false
        ...
        try {
            ...
            console.log("VIEW JS IMPORTING NODES")
