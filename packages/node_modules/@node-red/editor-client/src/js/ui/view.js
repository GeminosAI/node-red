...
RED.view = (function () {
    ...
    function init() {
        ...
        RED.events.on("workspace:change", function (event) {
            ...
            RED.menu.setDisabled("menu-item-workspace-edit", activeSubflow || event.workspace === 0 || activeSubmodel);
            RED.menu.setDisabled("menu-item-workspace-delete", event.workspace === 0 || RED.workspaces.count() == 1 || activeSubflow || activeSubmodel);
    ...
    function canvasMouseMove() {
        ...
        if (mouse_mode == RED.state.JOINING || mouse_mode === RED.state.QUICK_JOINING) {
            ...
            if (movingSet.length() === 1 && movingSet.get(0).n.type !== "group") {
                ...
                if (node.n.type !== 'subflow' && node.n.type !== "submodel" && !node.n.g && activeGroups) {
                    if (!groupHoverTimer) {
    ...
    function selectGroup(g, includeNodes, addToMovingSet) {
        ...
        // adds add a node to a moving a set 
