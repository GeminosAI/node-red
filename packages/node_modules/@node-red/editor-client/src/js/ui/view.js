    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            linkEnter.each(function(d,i) {
                ...
                if( (d.source.type ==="entity" && d.target.type === "relation" ) || (d.source.type==="relation" && d.target.type==="entity") || (d.source.type === "attribute" && d.target.type ==="relation") || (d.source.type === "relation" && d.target.type ==="attribute")){
