...
RED.view = (function () {
    ...
    async function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            try {
                pywhyinfo = await RED.causeway.getPyWhyLinkInfo()
            ...
            try {
                console.log("dag info", pywhyinfo, typeof pywhyinfo)
                if (Object.keys(pywhyinfo).length > 0) {
                    let edge_strength = pywhyinfo["edge_strength"]
                    let cms = pywhyinfo["causal_mechanisms"]
                    ...
                    let add_edge_text = async (type = "causal_mechanisms") => {
                        ...
                        // console.log(`${_fn} Pywhy info ${type} `, pywhyinfo[type])
                        // console.log(`${_fn} strategyType `, RED.causeway.causalAnalysisStrategyType)

                        if (Object.keys(pywhyinfo[type]).length > 0) {
