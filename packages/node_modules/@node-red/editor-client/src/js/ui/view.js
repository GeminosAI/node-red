        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            linkEnter.each(function(d,i) {
                ...
                if(d.source.type === "entity" || d.source.type === "relation"){
                    ...
                    markerArrow.setAttribute("markerWidth", "2")
                    markerArrow.setAttribute("markerHeight", "4")
                    markerArrow.setAttribute("refX","5")
                    markerArrow.setAttribute("refY","2")
                    markerArrow.setAttribute("orient", "auto")


                    var arrow = document.createElementNS("http://www.w3.org/2000/svg", "path")
                    arrow.setAttribute("d", "M0,0 V4 L2,2 Z")
                    arrow.setAttribute("style", "fill: red;")
                    markerArrow.appendChild(arrow)
                ...
                if(d.source.type ==="entity" || d.source.type ==="relation"){
                    pathLine.setAttribute("marker-end" , "url(#markerArrow)")
                    pathText.setAttributeNS("http://www.w3.org/1999/xlink", 'xlink:href', "#"+id);

                    pathText.textContent = (d.source.type ==="enitty") ? (d.target.name + ": " + d.source.name) : (d.source.name + ": " + d.target.name)
