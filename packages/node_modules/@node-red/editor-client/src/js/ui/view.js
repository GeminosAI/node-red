...
RED.view = (function () {
    ...
    function addNode(type, x, y) {
        ...
        if (activeSubmodel && c) {
            console.log("Active submodel: ", activeSubmodel)
            console.log("Value of c ", c, " : ", type)
            console.log(c[1])
            var submodelId = c[1];
    ...
    function canvasMouseDown() {
        ...
        if (!mousedown_node && !mousedown_link && !mousedown_group) {
            // GEMINOS
            console.log("IN CANVAS MOUSE DOWN ")
            selected_link = null;
            updateSelection();
        }
        if (mouse_mode === 0) {
    ...
    function nodeMouseDown(d) {
        // GEMINOS
        console.log("viewjs 3017 Node mouse down")
    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function (d, i) {
                ...
                if (d.outcome) {
                    // console.log("NODE IS OF TYPE TREATMENT", d.name)
                    mainRect.setAttribute("style", "stroke:;stroke-width:3; opacity:0.9;")
                }
            ...
            let colliders = RED.causeway.findColliders()
            let backdoors = RED.causeway.findBackdoors()
            console.log("here")
            if (typeof (backdoors) !== "undefined") {
                console.log("Backdoors at view.js ", backdoors, typeof (backdoors))
            }
            linkEnter.each(function (d, i) {
                ...
                if ((d.source.type === "entity" && d.target.type === "entity") || (d.source.type === "relation" && d.target.type === "relation") || (d.source.type === "attribute" && d.target.type === "attribute")) {
                    ...
                    // console.log(RED.nodes.node(d.target.id))
                    // console.log(target_node)
                    // target_node.wires.forEach(wire =>{
                    //     console.log(wire)
                    // })
                }
                ...
                if ((d.source.type === "event" || /^submodel:(.+)$/.exec(d.source.type)) && (d.target.type === "event" || /^submodel:(.+)$/.exec(d.target.type))) {
                    if (typeof (backdoors) !== "undefined") {
                        if (backdoors[[d.source.id, d.target.id]]) {
                            console.log("A BACKDOOR PATH ")
                            pathLine.setAttribute("class", "red-ui-backdoor-causal-link-line red-ui-flow-link-path" +
                                (d.link ? " red-ui-flow-link-link" : (activeSubflow ? " red-ui-flow-subflow-link" : "")));
                        }
                    }
    ...
    function importNodes(newNodesObj, options) {
        ...
        try {
            ...
            if (result) {
                ...
                console.log("Causal submodels: ", new_submodels)
