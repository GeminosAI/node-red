    ...
    async function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function (d, i) {
                ...
                node[0][0].__textGroup__ = text;
                // console.log("NODE ENTER TEXT ", text)
            ...
            try {
                /* The above code is a JavaScript comment block. It is not performing any specific
                action in the code, but it is used to provide information or explanations about the
                code for developers who may be reading it. */
                // clear previous ancestor values 
                await RED.causeway.clearICC(true)
            ...
            try {
                console.log("pywhylinkinfo: ", pywhyLinkInfo)
                        ...
                        if (Object.keys(pywhyLinkInfo[type]).length > 0) {
                            for await (let effect of Object.keys(parent_child_indexer)) {
                                ...
                                if (type === "edge_strength") {
                                        ...
                                        if (cause.type === "causeeffect") {
                                            ...
                                            if (RED.causeway.causalAnalysisStrategyType === "mean") {
                                                if (cms[effect.id] !== undefined) {
                                                    ...
                                                    // console.log(" PATH class list ", path[0].classList)
                                                    ...
                                                    if (edge_value.includes("degree")) {
                                                        ...
                                                        if (edgeColor !== "grey") {
                                                            ...
                                                            // console.log(path[0].classList.contains(pathColor))
                                                            if (!path[0].classList.contains(pathColor)) {
                                                        ...
                                                        if (edge_value !== "-0" && edge_value !== "-0.00") {
                                                            if (negative) {
                                                                // console.log("path was previosly NEGATIVE ", path[0].classList.contains("red-ui-negative-link-line"))
                                                                if (!path[0].classList.contains("red-ui-negative-link-line")) {
                                                                    path[0].classList.remove("red-ui-negative-link-line")
                                                                    path[0].classList.remove("red-ui-positive-link-line")
                                                                    path[0].classList.add("red-ui-negative-link-line")
                                                                }
                                                            } else {
                                                                // console.log("path was previosly POSITIVE ", path[0].classList.contains("red-ui-positive-link-line"))
                                                                if (!path[0].classList.contains("red-ui-positive-link-line")) {
                                                                    path[0].classList.remove("red-ui-negative-link-line")
                                                                    path[0].classList.remove("red-ui-positive-link-line")
                                                ...
                                                if (cms[effect.id] === undefined) {
                                                    // console.log("UNDEFINED RELATIONSHIP FOR CM")
                                                    // console.log(cause.name + " === > " + effect.name)
                                                    path[0].classList.remove("red-ui-negative-link-line")
                                                    path[0].classList.remove("red-ui-positive-link-line")
                                    ...
                                    // if (RED.causeway.causalAnalysisStrategyType === "mean") {
                                    //     console.log("UPDATE ICC VIEW")
                                    //     // clear any ICC values that remain 
                                    //     await RED.causeway.updateICCView()
                                    // }
                                }
