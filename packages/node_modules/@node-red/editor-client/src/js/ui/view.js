...
RED.view = (function() {
    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            console.log("#YO: ENTERING LINK ", link)            
            console.log("#YO: Type of link ", typeof link)
            ...
            linkEnter.each(function(d,i) {
                ...
                if(d.source.type ==="entity" || d.source.type==="relation"){
                    ...
                    pathText.textContent = (d.source.type ==="entity") ? (d.target.name + ": " + d.source.name) : (d.source.name + ": " + d.target.name)
