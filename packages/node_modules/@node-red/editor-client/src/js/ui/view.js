...
RED.view = (function () {
    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            let backdoors = RED.causeway.getBackdoors()
            if (Object.keys(backdoors).length > 0) {
                console.log("link layer selection: ", linkLayer.selectAll(".red-ui-flow-link-line"))
            ...
            linkEnter.each(function (d, i) {
                ...
                if ((d.source.type === "event" || /^submodel:(.+)$/.exec(d.source.type)) && (d.target.type === "event" || /^submodel:(.+)$/.exec(d.target.type))) {
                    if (typeof (backdoor_wires) !== "undefined" && Object.keys(backdoor_wires).length > 0) {
                        if (backdoor_wires[[d.source.id, d.target.id]]) {
