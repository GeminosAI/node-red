...
RED.view = (function () {
    ...
    async function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            console.log("backdoor keys ", backdoorKeys)
            console.log("frontdoor keys ", frontdoorKeys)
                ...
                linkLayer.selectAll(".red-ui-flow-link-line").attr("class",
                    function (d, i) {
                        ...
                        if (frontdoorKeys.has(pathId)) {
                            console.log("frontdoor keys has path id")
            ...
            try {
                pywhy_info = await RED.causeway.getPyWhyLinkInfo()
            ...
            try {
                console.log("pyhwhy info", pywhy_info, typeof pywhy_info)
                if (Object.keys(pywhy_info).length > 0) {
                    let edge_strength = pywhy_info["edge_strength"]
                    let add_edge_strength_text = (edge, textPath) => {
                            ...
                            for await (let cause of parent_child_indexer[effect.id]) {
                                ...
                                if (cause.type === "causeeffect") {
                                    ...
                                    if (edge_strength[effect.id] !== undefined) {
                                        console.log(edge_strength[effect.id].hasOwnProperty(cause.name))
