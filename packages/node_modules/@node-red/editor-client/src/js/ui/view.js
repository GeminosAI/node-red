...
RED.view = (function () {
    ...
    function init() {
        ...
        RED.events.on("workspace:change", function (event) {
            ...
            if (activeSubmodel) {
                RED.menu.setDisabled("menu-item-workspace-edit", activeSubmodel);
    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            console.log("backdoors size", backdoors.length)
