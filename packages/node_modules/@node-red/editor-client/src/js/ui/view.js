    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            linkEnter.each(function(d,i) {
                ...
                // geminos
                if(d.source.type === "entity" || d.source.type === "relation" || d.source.type==="event" || /^submodel:(.+)$/.exec(d.source.type)){
                ...
                if( (d.source.type ==="entity" & d.target.type=== "entity") || (d.source.type ==="relation" && d.target.type==="relation") )
                {
