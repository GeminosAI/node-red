...
RED.view = (function () {
    ...
    function _redraw() {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            // console.log("bacdkoor wires ", backdoors)
            // console.log("frontdoor wires ", frontdoors)

            // GEMINOS: added section
            linkLayer.selectAll(".red-ui-backdoor-causal-link-line").attr("class",
                function (d, i) {
                    return "red-ui-flow-link-line red-ui-flow-link-path" +
                        (d.link ? " red-ui-flow-link-link" : (activeSubflow ? " red-ui-flow-subflow-link" : ""));
                })
            linkLayer.selectAll(".red-ui-frontdoor-causal-link-line").attr("class",
                function (d, i) {
                    return "red-ui-flow-link-line red-ui-flow-link-path" +
                        (d.link ? " red-ui-flow-link-link" : (activeSubflow ? " red-ui-flow-subflow-link" : ""));
                })
            ...
            if (backdoors.size > 0 || frontdoors.size > 0) {
                linkLayer.selectAll(".red-ui-flow-link-line").attr("class",
                    function (d, i) {
                        // GEMINOS: added section 
                        if (backdoors.has(d.source.id + "," + d.target.id)) {
                            return "red-ui-backdoor-causal-link-line red-ui-flow-link-path" +
                                (d.link ? " red-ui-flow-link-link" : (activeSubflow ? " red-ui-flow-subflow-link" : ""));
                        }
                        if (frontdoors.has(d.source.id + "," + d.target.id)) {
                            return "red-ui-frontdoor-causal-link-line red-ui-flow-link-path" +
                                (d.link ? " red-ui-flow-link-link" : (activeSubflow ? " red-ui-flow-subflow-link" : ""));
                            // GEMINOS eof added section 
                        } else {
                            return "red-ui-flow-link-line red-ui-flow-link-path" +
