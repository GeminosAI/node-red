 ...
 **/
 RED.nodes = (function () {
    ...
    function addNode(n) {
      ...
      if (n.type.indexOf("subflow") !== 0 && n.type.indexOf("submodel")!== 0) {
        ...
        if (n.type.indexOf("subflow") === 0){
          ...
          var sf = RED.nodes.subflow(submodelId);
          if (sf) {
            sf.instances.push(sf);
          }
          n["_"] = RED._;
      ...
      if (n._def.category == "config") {
        ...
        if ( (n._def.category == "subflows" && typeof n.i === "undefined") || (n._def.category == "submodel" && typeof n.i === "undefined")) {
          var nextId = 0;
    ...
    function getSubmodel(id) {
      //gem
      console.log("gettingSubmodel")
      return submodels[id];
    }
    function addSubmodel(sf, createNewIds) {
      console.log("Adding submodel");
      if (createNewIds) {
    ...
    function createCompleteNodeSet(exportCredentials) {
      ...
      for (i in submodels){
        if(submodels.hasOwnProperty(i)){
          nns.push(convertNode(submodels[i], exportCredentials))
        }
      }
      return nns;
    }
    ...
    function importNodes(newNodesObj, options) {
      ...
      for (i = 0; i < newNodes.length; i++) {
        ...
        var m = /^submodel:(.+)$/.exec(newNodes[i].type);
        if (m) {
          var submodelId = m[1];
