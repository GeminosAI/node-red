  ...
  var allNodes = (function () {
    ...
    var api = {
      ...
      eachNode: function (cb) {
        ...
        // for some reason tabmap was failing ???
 ...
 */
  function importNodes(newNodesObj, options) {
    console.log("new nodes obejct ", newNodesObj)
      ...
      for (var i = 0; i < existingNodesCount; i++) {
        ...
        $("<li>")
          .text(
            ...
            (conflict.imported.type !== conflict.existing.type ? " | " + conflict.imported.type : "") + " ]")
          .appendTo(nodeList);
      }
