...
var RED = (function () {
      ...
      success: function (nodes) {
        if (nodes) {
          ...
          try {
            ...
            console.log("imported nodes from nodes.flows")
            RED.nodes.dirty(false);
            console.log("makred nodes dirty to false")
  ...
  function buildMainMenu() {
    ...
    if (RED.settings.theme("projects.enabled", false)) {
      menuOptions.push({
        id: "menu-item-projects-menu", label: RED._("menu.label.projects"), options: [
    ...
    menuOptions.push({
      id: "menu-item-edit-menu", label: RED._("menu.label.edit"), options: [
    ...
    menuOptions.push({
      id: "menu-item-arrange-menu", label: RED._("menu.label.arrange"), options: [
    ...
    // geminos
    menuOptions.push({
      id: "menu-item-submodel",
      label: "Causal Submodels",
      options: [{ id: "menu-item-submodel-create", label: "Create Causal Submodel", onselect: "core:create-submodel", },
      { id: "menu-item-submodel-convert", label: "Selection to Causal Submodel", onselect: "core:convert-to-submodel", },
      ],
    });
    // end of geminos

    menuOptions.push({
      id: "menu-item-group", label: RED._("menu.label.groups"), options: [
  ...
  function loadEditor() {
    ...
    // geminos
    try {
      RED.typeql.init(RED.settings.theme("deployButton", null));
      RED.causeway.init(RED.settings.theme("deployButton", null));
      RED.submodel.init();
    } catch (error) {
      console.log("Error in loading typeql: ", error);
    }
    // end of geminos
