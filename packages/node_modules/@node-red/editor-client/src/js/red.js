...
var RED = (function () {
    ...
    RED.comms.subscribe("notification/node/#", function (topic, msg) {
      ...
      if (topic == "notification/node/added") {
        ...
        if (addedTypes.length) {
          typeList =
            "<ul><li>" +
            addedTypes.map(RED.utils.sanitize).join("</li><li>") +
            "</li></ul>";
          RED.notify(
        ...
        for (i = 0; i < msg.length; i++) {
          ...
          if (info.added) {
            typeList =
              "<ul><li>" +
              m.types.map(RED.utils.sanitize).join("</li><li>") +
              "</li></ul>";
            RED.notify(
  ...
  function buildMainMenu() {
    ...
    menuOptions.push({
      ...
      options: [
        {
          id: "menu-item-submodel-create",
          label: "Create Causal Submodel",
          onselect: "core:create-submodel",
        },
        {
          id: "menu-item-submodel-convert",
          label: "Selection to Causal Submodel",
          onselect: "core:convert-to-submodel",
        },
      ],
    });
  ...
  var loader = {
    init: function () {
      ...
      var label = $("<div>", { class: "red-ui-loading-bar-label" }).appendTo(
        container
      );
