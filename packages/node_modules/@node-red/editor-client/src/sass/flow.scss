...
.red-ui-workspace-select-mode {
    ...
    g.red-ui-flow-node.red-ui-flow-node-hovered:not(.red-ui-flow-node-treatment-selected) {
        opacity: 0.9;
        .red-ui-flow-node {
            stroke-width: 5;
            stroke: $node-causal-treatment-color !important;
            stroke-dasharray: 10, 4;
        }
    }
}
...
// geminos
.red-ui-closed-causal-link-line {
    stroke: $backdoor-causal-link;
    stroke-width: 3;
    fill: none;
    pointer-events: none;
}
.red-ui-open-causal-link-line {
    stroke: $frontdoor-causal-link;
    stroke-width: 3;
    fill: none;
    pointer-events: none;
}
.red-ui-negative-link-line {
    stroke: $negative-causal-link;
    stroke-width: 3;
    fill: none;
    pointer-events: none;
}
.red-ui-positive-link-line {
    stroke: $positive-causal-link;
    stroke-width: 3;
    fill: none;
    pointer-events: none;
}
