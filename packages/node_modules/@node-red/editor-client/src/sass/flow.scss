...
g.red-ui-flow-node-selected {
    ...
    .red-ui-flow-node,.red-ui-flow-subflow-port, .red-ui-flow-submodel-port {
        stroke-width: 2;
        stroke: $node-selected-color !important;
    }
}
...
.red-ui-flow-subflow , .red-ui-flow-node, .red-ui-flow-submodel {
}
...
.red-ui-flow-subflow-port , .red-ui-flow-submodel-port{
    fill: $node-background-placeholder;
    stroke: $node-border;
}
