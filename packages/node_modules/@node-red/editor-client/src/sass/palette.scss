...
.red-ui-backdoor-open {
    background-color: rgba(173, 87, 217, 0.1);
}
.red-ui-backdoor-open.selected {
    background-color: rgba(173, 87, 217, 0.5);
}
.red-ui-backdoor-closed {
    background-color: rgba(255, 150, 0, 0.1)
}
.red-ui-backdoor-closed.selected {
    background-color: rgba(255, 150, 0, 0.5)
}


.red-ui-frontdoor-open {
    background-color: rgba(255, 150, 0, 0.1)
}
.red-ui-frontdoor-open.selected {
    background-color: rgba(255, 150, 0, 0.5)
}
.red-ui-frontdoor-closed {
    background-color: rgba(173, 87, 217, 0.1);
}
.red-ui-frontdoor-closed.selected {
    background-color: rgba(173, 87, 217, 0.5);
}


.red-ui-positive-link{
    background-color: rgba(0, 255, 98, 0.5);
}
.red-ui-negative-link{
