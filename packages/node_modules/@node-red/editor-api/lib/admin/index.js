...
module.exports = {
    init: function (settings, runtimeAPI) {
        ...
        adminApp.post("/causeway/getPyWhyInfo", needsPermission("causeway.read"), causeway.getPyWhyInfo, apiUtil.errorHandler);
        adminApp.post("/causeway/getModelAnalysis", needsPermission("causeway.read"), causeway.getModelAnalysis, apiUtil.errorHandler);
        adminApp.post("/causeway/getModelAnalysisTest", needsPermission("causeway.read"), causeway.getModelAnalysisTest, apiUtil.errorHandler);
        adminApp.post("/causeway/fetchCausalAnalysis", needsPermission("causeway.read"), causeway.fetchCausalAnalysis, apiUtil.errorHandler);
