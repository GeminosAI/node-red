...
module.exports = {
    init: function (settings, runtimeAPI) {
        ...
        adminApp.get("/typedb/get-all-databases", needsPermission("typedb.write"), typedb.get_all_databases, apiUtil.errorHandler);
        // adminApp.get("typedb/get-kg-concepts", needsPermission("typedb.write"), typedb.get_kg_concepts, apiUtil.errorHandler);

        adminApp.post("/typedb/deploy", needsPermission("typedb.write"), typedb.deploy, apiUtil.errorHandler)
        adminApp.post("/typedb/deploy_instances", needsPermission("typedb.write"), typedb.deploy_instances, apiUtil.errorHandler)
        adminApp.post("/typedb/deploy/knowledge", needsPermission("typedb.write"), typedb.knowledge, apiUtil.errorHandler);
        adminApp.post("/typedb/deploy/causal", needsPermission("typedb.write"), typedb.causal, apiUtil.errorHandler);


        adminApp.post("/causeway/set-context", needsPermission("causeway.write"), causeway.set_context, apiUtil.errorHandler);
        adminApp.post("/causeway/model-annotations", needsPermission("causeway.write"), causeway.model_annotations, apiUtil.errorHandler);
        adminApp.post("/causeway/check-collider", needsPermission("causeway.write"), causeway.check_collider, apiUtil.errorHandler);
        adminApp.post("/causeway/test", needsPermission("causeway.write"), causeway.test, apiUtil.errorHandler);
        adminApp.post("/causeway/find-backdoors", needsPermission("causeway.write"), causeway.find_backdoors, apiUtil.errorHandler);
