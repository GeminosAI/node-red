...
module.exports = {
    init: function (settings, runtimeAPI) {
        ...
        adminApp.get("/causewaydiscovery/getOpenAIResponse", needsPermission("causewaydiscovery.read"), causewaydiscovery.getOpenAIResponse, apiUtil.errorHandler);
        ...
        adminApp.post("/causewaydiscovery/storeGptInfo", needsPermission("causewaydiscovery.write"), causewaydiscovery.storeGptInfo, apiUtil.errorHandler)
