...
module.exports = {
    init: function (settings, runtimeAPI) {
        ...
        causeway.init(runtimeAPI);
        typedb.init(runtimeAPI);
        causewaydiscovery.init(runtimeAPI);
        ...
        // adminApp.post("/typedb/causal", needsPermission("typedb.write"), typedb.causal, apiUtil.errorHandler);
        adminApp.post("/typedb/storeCausalAnalysis", needsPermission("typedb.write"), typedb.storeCausalAnalysis, apiUtil.errorHandler);
        // adminApp.post("/causeway/findBackdoors", needsPermission("causeway.write"), causeway.findBackdoors, apiUtil.errorHandler);
        // adminApp.post("/causeway/dSeparation", needsPermission("causeway.write"), causeway.dSeparation, apiUtil.errorHandler);
        // adminApp.post("/causeway/frontdoorCriterion", needsPermission("causeway.write"), causeway.frontdoorCriterion, apiUtil.errorHandler);
