...
module.exports = {
    init: function (settings, runtimeAPI) {
        ...
        adminApp.post("/causeway/registerKnowledgeNode", needsPermission("causeway.write"), causeway.registerKnowledgeNode, apiUtil.errorHandler)
        adminApp.post("/causeway/registerCausalNode", needsPermission("causeway.write"), causeway.registerCausalNode, apiUtil.errorHandler)
