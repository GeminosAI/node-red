...
const causeway_config = require("../admin/causeway-version.json")

var defaultContext = {
    page: {
        title: `CWY ${causeway_config.type} ${causeway_config.version}`,
        favicon: "geminos-favi.ico",
        tabicon: {
            icon: "red/images/geminos-logo-tab.png",
            colour: "#8f0000"
        }
    },
    header: {
        title: `CAUSEWAY  ${causeway_config.type} ${causeway_config.version}`,
        image: "red/images/geminos-logo-17-18.png"
    },
    asset: {
        red: "red/red.min.js",
