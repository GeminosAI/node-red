...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        simplemocha: {
            ...
            typedb: { src: ["test/typedb/**/*_spec.js"] }
        },
        webdriver: {
            all: {
        ...
        nyc: {
            ...
            typedb: { cmd: false, args: ['grunt', 'simplemocha:typedb'] },
        },
        jshint: {
            options: {
                jshintrc: true
            ...
            vendor: {
                files: {
                    "packages/node_modules/@node-red/editor-client/public/vendor/vendor.js": [
                        ...
                        "packages/node_modules/@node-red/editor-client/src/vendor/chart-js/chart.min.js",
                        "packages/node_modules/@node-red/editor-client/src/vendor/observable/observable.min.js",
                        "packages/node_modules/@node-red/editor-client/src/vendor/viz/viz.js",
    ...
    // TypeDB unit testing
    grunt.registerTask('test-typedb', 'Runs unit tests for interaciton with TypeDB',
        ['build', 'nyc:typedb']);
